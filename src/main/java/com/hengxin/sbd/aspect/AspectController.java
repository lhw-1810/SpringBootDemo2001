package com.hengxin.sbd.aspect;
...
public class AspectController {
	 ...
	 */
	@Pointcut("execution(public * com.hengxin.sbd.modules.*.controller.*.*(..))")
	@Order(1)
	public void controllerPointCut() {}
	
	@Before(value = "com.hengxin.sbd.aspect.AspectController.controllerPointCut()")
	 ...
	 */
	@Around(value="com.hengxin.sbd.aspect.AspectController.controllerPointCut()")
	 ...
	 * -后置通知
	 */
	@After(value="com.hengxin.sbd.aspect.AspectController.controllerPointCut()")
